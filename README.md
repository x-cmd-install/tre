...
![tre](https://repo.x-cmd.io/tre.svg)
...
Total: **1,358** lines of code across **14** files in the top 5 languages.
...
- **Upstream**: <https://github.com/dduan/tre>
- **License**: MIT
...
- **Releases**: 11 · **Merged PRs**: 88 · **Open PRs**: 7 · **Closed issues**: 32 · **Open issues**: 16 · **Commits**: 190
...
Reported by **142** distros on [repology.org](https://repology.org/project/tre). **67** are ✅ on the latest upstream release, **65** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T20:17:17Z._
