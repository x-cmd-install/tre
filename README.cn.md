...
![tre](https://repo.x-cmd.io/tre.svg?lang=zh)
...
合计: **1,358** 行代码（覆盖前 5 种语言、共 **14** 个文件）。
...
- **上游仓库**: <https://github.com/dduan/tre>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.4.0` (2022-06-19)
- **最近提交**: 2022-07-13
- **Release 含资产**: 8 个

## 流行度

- **Star**: 1,223 · **Fork**: 31 · **开放 issue**: 48 · **贡献者**: 4

## 累计统计

- **发布数**: 11 · **已合并 PR**: 88 · **开放 PR**: 7 · **已关闭 issue**: 32 · **开放 issue**: 16 · **提交数**: 190
...
在 [repology.org](https://repology.org/project/tre) 上共有 **142** 个发行版报告此项目。**67** 个 ✅ 已是最新上游版本，**65** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Debian unstable | `0.9.0` | ✅ latest |
| Debian 14 | `0.9.0` | ✅ latest |
| Debian 13 | `0.9.0` | ✅ latest |
| Ubuntu 26.04 LTS | `0.9.0` | ✅ latest |
| Ubuntu 24.04 LTS | `0.8.0` | ⚠️ outdated |
| Arch | `0.9.0` | ✅ latest |
| Homebrew | `0.9.0` | ✅ latest |
| Fedora rawhide | `0.9.0` | ✅ latest |
| Nix unstable | `0.9.0` | ✅ latest |
| Void | `0.8.0` | ⚠️ outdated |
| Alpine edge | `0.8.0` | ⚠️ outdated |
| openSUSE Tumbleweed | `0.9.0` | ✅ latest |

## 改进这些数据

tre 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `tre` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/tre.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T20:17:18Z._
